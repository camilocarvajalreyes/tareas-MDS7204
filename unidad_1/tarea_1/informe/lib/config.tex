...
% MÁRGENES DE PÁGINA
\def\pagemarginbottom {2.81}       % Margen inferior página [cm]
\def\pagemarginleft {2.81}         % Margen izquierdo página [cm]
\def\pagemarginright {2.81}        % Margen derecho página [cm]
\def\pagemargintop {2.81}          % Margen superior página [cm]
