...
\insertimage[\label{img:series_x_y}]{img/series_x_y}{scale=0.45}{Serie original $X$ y mediciones $Y$.}
...
\insertimage[\label{img:x_pred_updt}]{img/x_x_updt_x_pred}{scale=0.45}{Serie X junto con las predicciones del filtro pre y post actualización}
