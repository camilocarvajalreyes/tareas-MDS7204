...
% MÁRGENES DE PÁGINA
\def\pagemarginbottom {2.2}       % Margen inferior página [cm]
\def\pagemarginleft {2.2}         % Margen izquierdo página [cm]
\def\pagemarginright {2.2}        % Margen derecho página [cm]
\def\pagemargintop {1.8}          % Margen superior página [cm]
