...
\insertimage[\label{img:untrained}]{img/untrained_gp_post}{scale=0.38}{Posterior para GP sin entrenar}

Notemos que \lipsum[1]. Por otro lado ...

\insertimage[\label{img:trained}]{img/trained_gp_post}{scale=0.38}{Posterior para GP entrenada}
